...
def main_apv():
    ...
    r1=requests.get("https://pastebin.com/raw/piP4rzLn").text
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    input("\x1b[1;97mPress enter to back Rehman Menu ")
...
def R():
			...
			print ("\033[1m [!] Tool    : Rehman Fast Clone")

			print (" [!] Brand   Itx Rehman ")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[Rehman TM]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      Rehman HACKER😊 \033[1;37m")
            ...
            print("\033[1;32m      Mr Rehman😊 \033[1;37m")
